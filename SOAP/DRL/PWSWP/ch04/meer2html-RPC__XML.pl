...
# Create a client object. The error_handler key specifies a
# callback to be invoked when a transport error occurs. If
# desired, a fault_handler could be installed for catching
# server-side errors, as well.
